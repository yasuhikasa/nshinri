    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.subtext}>
          ...
          <br />
          長く抱えてきた「生きにくさ」や心の負担から抜け出し、新しい自分を見つける時です。
          <br />
          あなたの一歩が、確かな変化に繋がります。
          <br />
          私と一緒に、その一歩を踏み出しましょう！
        ...
        <div className={styles.content}>
          ...
          <div className={styles.introduction}>
            <p>
              ...
              <br />
              　あなたが前に進むための具体的なサポートを、カウンセリングやライフコーチングを通じてお届けします。
              <br />
            ...
            <div className={styles.problemBlock}>
              <ul className={styles.cardList}>
                <li className={styles.card}>
                  ...
                  自分を大切にしながら、一歩ずつ前に進むための方法を提案します。自己肯定感を高め、新たな人生のスタートを支援します。
                </li>
                <li className={styles.card}>
                  <strong>介護に苦しむ人へのサポート</strong>:
                  介護のストレスや家族との関係に悩む方へ、現実的なアドバイスと心のケアを提供します。特に介護者の心の負担に寄り添います。
                </li>
                <li className={styles.card}>
                  <strong>就職支援のキャリアコーチング</strong>:
                  病気も克服し、40歳未経験でITエンジニアに転職した経験を活かし、多様な悩みに対応します。どんな方でもお気軽にご相談ください。
                </li>
                <li className={styles.card}>
                  <strong>新しいステップへのサポート</strong>:
                  新しい一歩を踏み出し、社会や人間関係の中で充実した生活を再構築する手助けをします。
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className={styles.targetContainer}>
            ...
            <div className={styles.targetBlock}>
              <p>
                心の病や生きにくさに悩む方だけでなく、介護の悩みや社会復帰、人間関係の構築に困難を感じている方も対象です。悩みの大きさに関わらず、まずは話してみませんか？
              </p>
              <ul className={styles.cardList}>
                <li className={styles.card}>
                  心の病や抑うつ感から抜け出そうとしても、次の一歩が踏み出せない方
                </li>
                <li className={styles.card}>
                ...
                <li className={styles.card}>
                  未経験からのIT転職を考えている方、未経験転職を検討している方
                </li>
                <li className={styles.card}>
