...
const counselingPrompt = `キャリアや人生のリスタートに悩んでいる人を励ます短い投稿を作成してください。以下のポイントを考慮してください：
- 30代・40代の人生立て直しや人生の迷いや不安を抱えている状況。
- その人が「一歩踏み出せる」と感じられるような励ましの言葉。
- 自信を持ち、前に進むための小さな行動案。
- トーンは優しく、共感的で前向きな内容にしてください。
- 140文字以内に収めてください。`;
