  ...
  return (
    <>
      ...
      <div className={styles.container}>
        {/* トップ部分 */}
        <h1 className={styles.heading}>人生を変える一歩を、今ここで踏み出しましょう</h1>
        <p className={styles.subtext}>
          仕事や人間関係に悩み、孤独や社会復帰への不安を抱えているあなたへ。<br />
          長く続いた「生きにくさ」から、今こそ抜け出す時です。<br />
          私と一緒に、その壁を一つずつ乗り越え、<strong>新しい自分</strong>を見つけましょう。<br />
          一歩ずつ前に進むことで、確実に変化が訪れます。
        </p>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.introduction}>
            <p>
              「どうせ自分なんて」と感じたり、失敗の恐怖に押しつぶされそうになっているあなたへ。誰かに話すことで、少しでも心が軽くなるかもしれません。<br /><br />
              「どうしてこんなに苦しいんだろう？」「どうして自分の人生はこんななんだろう」「どうして自分だけ・・・」「どうせ他人なんて・・・」<br /><br />
              カウンセリングやライフコーチングは、あなたの心に寄り添い、少しずつ前に進むためのサポートを提供します。小さな一歩から一緒に始めましょう。
            </p>
          </div>
